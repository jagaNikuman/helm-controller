...
func (r *HelmReleaseReconciler) reconcileRelease(ctx context.Context, run *runner.Runner, hr *v2.HelmRelease, rls *release.Release) (ctrl.Result, error) {
	...
	if released := meta.GetCondition(hr.Status.Conditions, v2.ReleasedCondition); released != nil {
		if released.Status == corev1.ConditionTrue {
	...
	if remediated != nil && remediated.Status == corev1.ConditionFalse {
		if remediated.Status == corev1.ConditionFalse {
	...
	if err != nil {
		...
		v2.SetHelmReleaseCondition(hr, v2.ReleasedCondition, corev1.ConditionFalse, failureReason, err.Error())
	...
	// marked as tested.
	v2.SetHelmReleaseCondition(hr, v2.ReleasedCondition, corev1.ConditionTrue, successReason, rls.Info.Description)
	v2.DeleteHelmReleaseCondition(hr, v2.TestSuccessCondition)
...
func (r *HelmReleaseReconciler) reconcileTest(ctx context.Context, run *runner.Runner, hr *v2.HelmRelease, rls *release.Release) (ctrl.Result, error) {
	...
	if released == nil || released.Status == corev1.ConditionFalse {
		return ctrl.Result{}, nil
	}
	...
	if err != nil {
		...
		v2.SetHelmReleaseCondition(hr, v2.TestSuccessCondition, corev1.ConditionFalse, v2.TestFailedReason, err.Error())
		...
		if !remediation.MustIgnoreTestFailures(hr.Spec.GetTest().IgnoreFailures) {
			remediation.IncrementFailureCount(hr)
			v2.SetHelmReleaseCondition(hr, v2.ReleasedCondition, corev1.ConditionFalse, v2.TestFailedReason, err.Error())
	...
	msg := "Tests succeeded"
	v2.SetHelmReleaseCondition(hr, v2.TestSuccessCondition, corev1.ConditionTrue, v2.TestSucceededReason, msg)
...
func (r *HelmReleaseReconciler) reconcileRemediation(ctx context.Context, run *runner.Runner, hr *v2.HelmRelease, rls *release.Release) (ctrl.Result, error) {
	...
	case v2.RollbackRemediationStrategy:
		if err := run.Rollback(*hr); err != nil {
			v2.SetHelmReleaseCondition(hr, v2.RemediatedCondition, corev1.ConditionFalse, v2.RollbackFailedReason, err.Error())
			v2.HelmReleaseNotReady(hr, v2.RollbackFailedReason, err.Error())
			return ctrl.Result{}, nil
		}
		v2.SetHelmReleaseCondition(hr, v2.RemediatedCondition, corev1.ConditionTrue, v2.RollbackSucceededReason, "Rollback complete")
	case v2.UninstallRemediationStrategy:
		if err := run.Uninstall(*hr); err != nil {
			v2.SetHelmReleaseCondition(hr, v2.RemediatedCondition, corev1.ConditionFalse, v2.UninstallFailedReason, err.Error())
			v2.HelmReleaseNotReady(hr, v2.UninstallFailedReason, err.Error())
			return ctrl.Result{}, nil
		}
		v2.SetHelmReleaseCondition(hr, v2.RemediatedCondition, corev1.ConditionTrue, v2.UninstallSucceededReason, "Uninstallation complete")
	}
	...
	if err != nil {
		v2.SetHelmReleaseCondition(hr, v2.RemediatedCondition, corev1.ConditionFalse, v2.GetLastReleaseFailedReason, err.Error())
		v2.HelmReleaseNotReady(hr, v2.GetLastReleaseFailedReason, err.Error())
		return ctrl.Result{}, nil
	}
	hr.Status.LastReleaseRevision = util.ReleaseRevision(rls)
